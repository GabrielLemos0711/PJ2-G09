<?php
    ...
    try {
        $stmt = $conn->prepare("SELECT  id, nome, email, senha, enderco, cidade, estado, telefone FROM cadastropessoa;");
        $stmt->execute();

        $cadastropessoas = $stmt->fetchAll(PDO::FETCH_ASSOC);
        ...
        $result["data"] = $cadastropessoas; //criamos o array para devolver o resultado do insert com os dados inseridos.
